...
import hla13.sklep.Produkty.ProduktyFederate;
import hla.rti1516e.*;
...
public class KasyFederateAmbassador extends NullFederateAmbassador
{
	    ...
	    throws FederateInternalError
	{
		...
		for( AttributeHandle attributeHandle : theAttributes.keySet() )
		{
			...
			{
				builder.append( attributeHandle );
				builder.append( " (Number Of Clients In FastQueue )    " );
				...
				federate.queueInfoNumberOfClientsInSlowQueue = available.getValue();
			}
			else if( attributeHandle.equals(federate.queueInfoNumberOfClientsInSlowQueueHandle) )
			{
				builder.append( attributeHandle );
				builder.append( " (Number Of Clients In SlowQueue )" );
				builder.append( ", attributeValue=" );
