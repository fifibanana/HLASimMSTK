...
public class KasyFederate
{
	...
	protected AttributeHandle queueInfoNumberOfClientsInFastQueueHandle;
	protected AttributeHandle queueInfoNumberOfClientsInSlowQueueHandle;
	protected AttributeHandle queueNumberOfProductsForClientFastQueueHandle;
	protected AttributeHandle queueNumberOfProductsForClientSlowQueueHandle;
	...
	protected int queueInfoNumberOfClientsInSlowQueue = 0;
	protected int queueInfoNumberOfClientsInFastQueue = 0;
	protected int queueNumberOfProductsForFastQueue = 0;
	protected int queueNumberOfProductsForSlowQueue = 0;
	...
	public void runFederate( String federateName ) throws Exception
	{
		...
		while( fedamb.federateTime < federationTimeLimit )
		{
			...
			if(queueInfoNumberOfClientsInSlowQueue - consumed >= 0  || queueInfoNumberOfClientsInFastQueue - consumed >= 0  ) {
	...
	private void publishAndSubscribe() throws RTIexception
	{
		...
		this.queueInfoNumberOfClientsInFastQueueHandle = rtiamb.getAttributeHandle( queueInfoHandle, "numberOfClientsInQueueA" );
		this.queueInfoNumberOfClientsInSlowQueueHandle = rtiamb.getAttributeHandle( queueInfoHandle, "numberOfClientsInQueueB" );
		this.queueNumberOfProductsForClientFastQueueHandle = rtiamb.getAttributeHandle( queueInfoHandle, "numberOfProductsForClientA" );
		this.queueNumberOfProductsForClientSlowQueueHandle = rtiamb.getAttributeHandle( queueInfoHandle, "numberOfProductsForClientB" );
		this.queueMaxNumberOfClientsHandle = rtiamb.getAttributeHandle( queueInfoHandle, "maxNumberOfClients" );

//		// package the information into a handle set
		AttributeHandleSet attributes = rtiamb.getAttributeHandleSetFactory().create();
		attributes.add(queueInfoNumberOfClientsInFastQueueHandle);
		attributes.add( queueInfoNumberOfClientsInSlowQueueHandle );
		attributes.add(queueNumberOfProductsForClientFastQueueHandle);
		attributes.add(queueNumberOfProductsForClientSlowQueueHandle);
